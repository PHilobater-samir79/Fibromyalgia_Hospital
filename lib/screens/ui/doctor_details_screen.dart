                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                      child: Text('100\nRuning',style: AppTextStyle.styleRegular15.copyWith(fontSize: 17,fontWeight: FontWeight.w400),textAlign: TextAlign.center,)),
                                ),
                              ),
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                      child: Text('500\nOngoing',style: AppTextStyle.styleRegular15.copyWith(fontSize: 17,fontWeight: FontWeight.w400),textAlign: TextAlign.center,)),
                                ),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(right: 10.0),
                                child: Container(
                                  ...
                                  child: Center(
                                      child: Text('300\nPatient',style: AppTextStyle.styleRegular15.copyWith(fontSize: 17,fontWeight: FontWeight.w400),textAlign: TextAlign.center,)),
                                ),
                              ),
